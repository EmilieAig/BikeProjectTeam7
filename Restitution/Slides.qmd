...
![](/images/timeline_tourdefrance.png){.absolute top=80 left=600 width="600" height="150"}
:::
...
![](/images/timeline_prediction.png){.absolute top=270 left=600 width="600" height="150"}
:::

::: {.fragment}
- <p class = "text"> Dates de support : 1er avril - 9 juillet 2023 </p>
![](/images/timeline_support.png){.absolute top=460 left=600 width="600" height="150"}
:::
...
::: {.fragment}
**Pourquoi Prophet comme modèle de prévision ?**
:::
