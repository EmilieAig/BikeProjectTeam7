...
<div style="position: fixed; bottom: 50px; left: 50px; width: 250px; height: 140px; 
    ...
    <i style="background:#FF2503; width:15px; height:15px; display:inline-block;"></i> > 1500 (High Intensity)<br>
    <i style="background:#FF9A03; width:15px; height:15px; display:inline-block;"></i> 1000-1500<br>
    <i style="background:#FCE80D; width:15px; height:15px; display:inline-block;"></i> 500-1000<br>
    <i style="background:#0DB0A4; width:15px; height:15px; display:inline-block;"></i> < 500 (Low Intensity)<br>
</div>
'''
