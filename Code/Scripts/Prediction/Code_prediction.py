...
# Ajouter les chemins entre tous les points connectés
print("Traçage des chemins...")
...
for _, row in merged_data.iterrows():
    ...
    folium.CircleMarker(
        ...
        fill_color=color,
        fill_opacity=0.9,
        popup=f"Station: {station_name}<br>Intensité: {intensity:.2f}"
    ).add_to(m)

# Sauvegarder la carte
output_file = '/home/anne_laure/HA712X/BikeProjectTeam7/Code/Scripts/Prediction/map_prediction_with_stations.html'
m.save(output_file)
