...
<p class="text"> Convert a JSON file containing EcoCompt data to a CSV file and filter the data for a specific date range. </p>
...
<p class="text"> Process all JSON files in a directory, converting each to a filtered CSV file in a target folder. </p>
